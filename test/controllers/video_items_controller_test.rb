...
class VideoItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create video_item' do
    assert_difference('VideoItem.count') do
      post video_items_url,
           params: { video_item: { extra: @video_item.extra, site: @video_item.site, streams: @video_item.streams,
                                   title: @video_item.title, url: @video_item.url } }
    end
  ...
  test 'should update video_item' do
    patch video_item_url(@video_item),
          params: { video_item: { extra: @video_item.extra, site: @video_item.site, streams: @video_item.streams,
                                  title: @video_item.title, url: @video_item.url } }
